...
function _setPrototypeOf(e2, t) {
  return (_setPrototypeOf = Object.setPrototypeOf || function(e3, t2) {
...
function _unsupportedIterableToArray(e2, t) {
  if (e2) {
    ...
    return r === "Object" && e2.constructor && (r = e2.constructor.name), r === "Map" || r === "Set" ? Array.from(e2) : r === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? _arrayLikeToArray(e2, t) : void 0;
  }
}
...
function isSpecial(e2) {
  ...
  return t === "[object RegExp]" || t === "[object Date]" || isReactElement(e2);
}
...
function cloneUnlessOtherwiseSpecified(e2, t) {
  return t.clone !== false && t.isMergeableObject(e2) ? deepmerge(emptyTarget(e2), e2, t) : e2;
}
...
var CarouselPropTypes = { children: propTypes.oneOfType([propTypes.arrayOf(propTypes.node), propTypes.node]), direction: propTypes.oneOf(["forward", "backward"]), height: function(e2, t) {
  var r = e2[t];
  return e2.orientation !== "vertical" || r !== null && typeof r == "number" ? null : new Error("Missing required property '".concat(t, "' when orientation is vertical.  You must supply a number representing the height in pixels"));
}, orientation: propTypes.oneOf(["horizontal", "vertical"]), isBgImage: function(e2, t) {
  return e2[t] === true && e2.tag === "img" ? new Error("HTML img elements should not have a backgroundImage.  Please use ".concat(t, " for other block-level HTML tags, like div, a, section, etc...")) : null;
} };
...
var ButtonBack = function(e2) {
  ...
  return _createClass(t, [{ key: "handleOnClick", value: function(e3) {
    var t2 = this.props, r2 = t2.carouselStore, i = t2.currentSlide, n = t2.onClick, s2 = t2.step, a = t2.infinite, o = t2.visibleSlides, l = t2.totalSlides - o, c = Math.max(i - s2, 0);
    a && (c = i === 0 ? l : c), r2.setStoreState({ currentSlide: c, isPlaying: false }, n !== null && n.call(this, e3));
  } }, { key: "render", value: function() {
    var e3 = this.props, r2 = (e3.carouselStore, e3.className), i = (e3.currentSlide, e3.disabled, e3.onClick, e3.step, e3.totalSlides, e3.visibleSlides, e3.infinite), n = _objectWithoutProperties(e3, _excluded), a = cn([s.buttonBack, "carousel__back-button", r2]), o = t.setDisabled(this.props.disabled, this.props.currentSlide, i);
    return import_react.default.createElement("button", _extends({ type: "button", "aria-label": "previous", className: a, onClick: this.handleOnClick, disabled: o }, n), this.props.children);
  } }], [{ key: "setDisabled", value: function(e3, t2, r2) {
    return e3 !== null ? e3 : t2 === 0 && !r2;
  } }]), t;
}(import_react.default.Component);
...
var jkrosoType = createCommonjsModule(function(e2, t) {
  var r = {}.toString, i = typeof window != "undefined" ? window.Node : Function;
  e2.exports = t = function(e3) {
    var t2 = typeof e3;
    if (t2 != "object")
      return t2;
    if (t2 = n[r.call(e3)], t2 == "object")
...
var deepFreeze = function e(t) {
  return Object.freeze(t), Object.getOwnPropertyNames(t).forEach(function(r) {
    !t.hasOwnProperty(r) || t[r] === null || typeof t[r] != "object" && typeof t[r] != "function" || Object.isFrozen(t[r]) || e(t[r]);
  }), t;
};
...
var Store = function() {
  ...
  return _createClass(e2, [{ key: "setStoreState", value: function(e3, t) {
    ...
    t !== -1 && this.subscriptions.splice(t, 1);
  } }, { key: "updateSubscribers", value: function(e3) {
    this.subscriptions.forEach(function(e4) {
      return e4();
    }), typeof e3 == "function" && e3(this.getStoreState());
  } }, { key: "subscribeMasterSpinner", value: function(e3) {
    Object.keys(this.masterSpinnerSubscriptions).indexOf(e3) === -1 && (this.masterSpinnerSubscriptions[e3] = { success: false, error: false, complete: false });
  } }, { key: "unsubscribeMasterSpinner", value: function(e3) {
    return Object.keys(this.masterSpinnerSubscriptions).indexOf(e3) !== -1 && (this.setMasterSpinnerFinished(), delete this.masterSpinnerSubscriptions[e3]);
    ...
    var e3 = this;
    return Object.keys(this.masterSpinnerSubscriptions).filter(function(t) {
      return e3.masterSpinnerSubscriptions[t].complete !== true;
    }).length === 0;
  } }]), e2;
}();
...
var _class;
var _temp;
var CarouselProvider = (_temp = _class = function(e2) {
  function t(e3) {
    var i;
    if (_classCallCheck(this, t), i = r.call(this, e3), e3.isIntrinsicHeight && e3.orientation !== "horizontal")
...
var _class$1;
var _temp$1;
var ButtonFirst = (_temp$1 = _class$1 = function(e2) {
  function t() {
    var e3;
  ...
  return _createClass(t, [{ key: "handleOnClick", value: function(e3) {
    ...
    r2.setStoreState({ currentSlide: 0, isPlaying: false }, i !== null && i.call(this, e3));
  } }, { key: "render", value: function() {
    var e3 = this.props, t2 = (e3.carouselStore, e3.className), r2 = e3.currentSlide, i = e3.disabled, n = (e3.onClick, e3.totalSlides, _objectWithoutProperties(e3, _excluded$2)), s2 = cn([s$1.buttonFirst, "carousel__first-button", t2]), a = i !== null ? i : r2 === 0;
    return import_react.default.createElement("button", _extends({ type: "button", "aria-label": "first", className: s2, onClick: this.handleOnClick, disabled: a }, n), this.props.children);
  } }]), t;
}(import_react.default.Component), _defineProperty(_class$1, "propTypes", { carouselStore: propTypes.object.isRequired, children: CarouselPropTypes.children.isRequired, className: propTypes.string, currentSlide: propTypes.number.isRequired, disabled: propTypes.bool, onClick: propTypes.func, totalSlides: propTypes.number.isRequired }), _defineProperty(_class$1, "defaultProps", { className: null, disabled: null, onClick: null }), _temp$1);
...
var _class$2;
var _temp$2;
var ButtonNext = (_temp$2 = _class$2 = function(e2) {
  function t(e3) {
    var i;
    return _classCallCheck(this, t), i = r.call(this, e3), i.handleOnClick = i.handleOnClick.bind(_assertThisInitialized(i)), i;
  }
  ...
  var r = _createSuper(t);
  return _createClass(t, [{ key: "handleOnClick", value: function(e3) {
    var t2 = this.props, r2 = t2.currentSlide, i = t2.onClick, n = t2.step, s2 = t2.carouselStore, a = t2.infinite, o = t2.totalSlides - t2.visibleSlides, l = n + r2, c = Math.min(l, o);
    a && (c = o === r2 ? 0 : c), s2.setStoreState({ currentSlide: c, isPlaying: false }, i !== null && i.call(this, e3));
  } }, { key: "render", value: function() {
    var e3 = this.props, r2 = (e3.carouselStore, e3.className), i = e3.currentSlide, n = e3.disabled, s2 = (e3.onClick, e3.step, e3.totalSlides), a = e3.visibleSlides, o = e3.infinite, l = _objectWithoutProperties(e3, _excluded$3), c = cn([s$2.buttonNext, "carousel__next-button", r2]), u = t.setDisabled(n, i, a, s2, o);
    ...
    return e3 !== null ? e3 : t2 >= i - r2 && !n;
  } }]), t;
}(import_react.default.PureComponent), _defineProperty(_class$2, "propTypes", { carouselStore: propTypes.object.isRequired, children: CarouselPropTypes.children.isRequired, className: propTypes.string, currentSlide: propTypes.number.isRequired, disabled: propTypes.bool, onClick: propTypes.func, step: propTypes.number.isRequired, totalSlides: propTypes.number.isRequired, visibleSlides: propTypes.number.isRequired, infinite: propTypes.bool }), _defineProperty(_class$2, "defaultProps", { className: null, disabled: null, onClick: null, infinite: false }), _temp$2);
...
var _class$3;
var _temp$3;
var ButtonLast = (_temp$3 = _class$3 = function(e2) {
  function t() {
    var e3;
    return _classCallCheck(this, t), e3 = r.call(this), e3.handleOnClick = e3.handleOnClick.bind(_assertThisInitialized(e3)), e3;
  }
  ...
  return _createClass(t, [{ key: "handleOnClick", value: function(e3) {
    ...
    r2.setStoreState({ currentSlide: n - s2, isPlaying: false }, i !== null && i.call(this, e3));
  } }, { key: "render", value: function() {
    var e3 = this.props, t2 = (e3.carouselStore, e3.className), r2 = e3.currentSlide, i = e3.disabled, n = (e3.onClick, e3.totalSlides), s2 = e3.visibleSlides, a = _objectWithoutProperties(e3, _excluded$4), o = cn([s$3.buttonLast, "carousel__last-button", t2]), l = i !== null ? i : r2 >= n - s2;
    return import_react.default.createElement("button", _extends({ type: "button", "aria-label": "last", className: o, onClick: this.handleOnClick, disabled: l }, a), this.props.children);
  } }]), t;
}(import_react.default.Component), _defineProperty(_class$3, "propTypes", { carouselStore: propTypes.object.isRequired, children: CarouselPropTypes.children.isRequired, className: propTypes.string, currentSlide: propTypes.number.isRequired, disabled: propTypes.bool, onClick: propTypes.func, totalSlides: propTypes.number.isRequired, visibleSlides: propTypes.number.isRequired }), _defineProperty(_class$3, "defaultProps", { className: null, disabled: null, onClick: null }), _temp$3);
...
var _class$4;
var _temp$4;
var ButtonPlay = (_temp$4 = _class$4 = function(e2) {
  function t(e3) {
    var i;
    return _classCallCheck(this, t), i = r.call(this, e3), i.handleOnClick = i.handleOnClick.bind(_assertThisInitialized(i)), i;
  }
  ...
  return _createClass(t, [{ key: "handleOnClick", value: function(e3) {
    ...
    this.props.carouselStore.setStoreState({ isPlaying: !this.props.isPlaying }, t2 !== null && t2.call(this, e3));
  } }, { key: "render", value: function() {
    var e3 = this.props, t2 = (e3.carouselStore, e3.children, e3.childrenPaused), r2 = e3.childrenPlaying, i = e3.className, n = e3.isPlaying, s2 = (e3.onClick, _objectWithoutProperties(e3, _excluded$5)), a = cn([s$4.buttonNext, "carousel__play-button", i]);
    return import_react.default.createElement("button", _extends({ type: "button", "aria-label": "play", className: a, onClick: this.handleOnClick }, s2), n && r2, !n && t2, this.props.children);
  } }]), t;
}(import_react.default.PureComponent), _defineProperty(_class$4, "propTypes", { carouselStore: propTypes.object.isRequired, children: propTypes.node, childrenPaused: propTypes.node, childrenPlaying: propTypes.node, className: propTypes.string, isPlaying: propTypes.bool.isRequired, onClick: propTypes.func }), _defineProperty(_class$4, "defaultProps", { children: null, childrenPaused: null, childrenPlaying: null, className: null, onClick: null }), _temp$4);
...
var _class$5;
var _temp$5;
var Dot = (_temp$5 = _class$5 = function(e2) {
  function t(e3) {
    var i;
    return _classCallCheck(this, t), i = r.call(this, e3), i.handleOnClick = i.handleOnClick.bind(_assertThisInitialized(i)), i;
  }
  ...
  var r = _createSuper(t);
  return _createClass(t, [{ key: "handleOnClick", value: function(e3) {
    var t2 = this.props, r2 = t2.carouselStore, i = t2.onClick, n = t2.slide, s2 = t2.totalSlides, a = t2.visibleSlides, o = n >= s2 - a ? s2 - a : n;
    r2.setStoreState({ currentSlide: o, isPlaying: false }, i !== null && i.call(this, e3));
  } }, { key: "render", value: function() {
    var e3 = this.props, t2 = (e3.carouselStore, e3.children, e3.className), r2 = e3.currentSlide, i = e3.disabled, n = (e3.onClick, e3.selected), s2 = e3.slide, a = (e3.totalSlides, e3.visibleSlides), o = _objectWithoutProperties(e3, _excluded$6), l = s2 >= r2 && s2 < r2 + a, c = typeof n == "boolean" ? n : l, u = l === true, p = typeof i == "boolean" ? i : u, d = cn([s$5.dot, c && s$5.dotSelected, "carousel__dot", "carousel__dot--".concat(s2), c && "carousel__dot--selected", t2]);
    return import_react.default.createElement("button", _extends({ "aria-label": "slide dot", type: "button", onClick: this.handleOnClick, className: d, disabled: p }, o), this.props.children);
  } }]), t;
}(import_react.default.Component), _defineProperty(_class$5, "propTypes", { carouselStore: propTypes.object.isRequired, children: CarouselPropTypes.children, className: propTypes.string, currentSlide: propTypes.number.isRequired, disabled: propTypes.bool, onClick: propTypes.func, selected: propTypes.bool, slide: propTypes.number.isRequired, totalSlides: propTypes.number.isRequired, visibleSlides: propTypes.number.isRequired }), _defineProperty(_class$5, "defaultProps", { children: null, className: null, disabled: null, onClick: null, selected: null }), _temp$5);
...
var _class$6;
var _temp$6;
var DotGroup = (_temp$6 = _class$6 = function(e2) {
  function t() {
  ...
  return _createClass(t, [{ key: "renderDots", value: function() {
    var e3 = this.props, t2 = e3.currentSlide, r2 = e3.totalSlides, i = e3.visibleSlides, n = e3.disableActiveDots, s2 = e3.showAsSelectedForCurrentSlideOnly, a = e3.renderDots;
    if (a) {
      var o = this.props;
      o.renderDots;
...
var Image = function(e2) {
  ...
  return _createClass(t, [{ key: "componentDidMount", value: function() {
    ...
    return typeof this.props[e3] == "function" ? this.props[e3]() : this.props.children;
    ...
    var t2 = this.props, r2 = t2.style, i = t2.tag, n = cn([s$7.image, "carousel__image", this.props.isBgImage && "carousel__image--with-background", "carousel__image--success", this.props.className]), s2 = _extends({}, r2), a = e3;
    if (i !== "img") {
      var o = e3.src;
      e3.alt;
      a = _objectWithoutProperties(e3, _excluded$8), s2 = _extends({}, r2, { backgroundImage: 'url("'.concat(o, '")'), backgroundSize: "cover" });
    }
    return import_react.default.createElement(i, _extends({ className: n, style: s2 }, a), this.props.children);
  } }, { key: "render", value: function() {
...
var _class$7;
var _temp$7;
var Spinner = (_temp$7 = _class$7 = function(e2) {
  function t() {
    return _classCallCheck(this, t), r.apply(this, arguments);
  }
  _inherits(t, e2);
...
}(import_react.default.PureComponent), _defineProperty(_class$7, "propTypes", { className: propTypes.string }), _defineProperty(_class$7, "defaultProps", { className: null }), _temp$7);
...
var ImageWithZoom = (_temp$8 = _class$8 = function(e2) {
  function t(e3) {
    var i;
  ...
  return _createClass(t, [{ key: "componentDidUpdate", value: function(e3, t2) {
    t2.isZooming === false && this.state.isZooming === true && this.props.carouselStore.setStoreState({ isPageScrollLocked: true }), t2.isZooming === true && this.state.isZooming === false && this.props.carouselStore.setStoreState({ isPageScrollLocked: false });
    ...
    if (this.state.isZooming) {
      ...
      if (i.length === 2) {
        e3.stopPropagation();
        var n = e3.target.getBoundingClientRect(), s2 = i[0].identifier, a = i[1].identifier, o = { x1: this.tpCache[s2].clientX, y1: this.tpCache[s2].clientY, x2: this.tpCache[a].clientX, y2: this.tpCache[a].clientY };
        ...
        var p = pct(boundedRange({ min: 0, max: 100, x: (c.cx - n.left) / n.width * 100 })), d = pct(boundedRange({ min: 0, max: 100, x: (c.cy - n.top) / n.height * 100 })), h = function(e4) {
          return boundedRange({ min: 1, max: MAX_TOUCH_SCALE, x: e4.scale + (c.distance - o.distance) / 100 });
        };
        this.setState(function(e4) {
          return { isZooming: h(e4) !== 1, scale: h(e4), x: p, y: d };
        });
      }
    }
    ...
    }), Object.keys(this.tpCache).length === 0 && this.setState({ isZooming: false }));
    ...
    var e3 = this.props, t2 = e3.alt, r2 = e3.bgImageProps, i = e3.bgImageTag, n = (e3.carouselStore, e3.className), s2 = e3.imageClassName, a = e3.overlayClassName, o = (e3.isPinchZoomEnabled, e3.spinner, e3.src), l = e3.srcZoomed, c = e3.tag, u = _objectWithoutProperties(e3, _excluded$a), p = cn([s$9.container, n]), d = cn([s$9.image, "carousel__zoom-image", s2]), h = cn([s$9.overlay, "carousel__zoom-image-overlay", this.state.isHovering && s$9.hover, this.state.isZooming && s$9.zoom, this.state.isHovering && "carousel__zoom-image-overlay--hovering", this.state.isZooming && "carousel__zoom-image-overlay--zooming", a]), y = {};
    return (this.state.isHovering || this.state.isZooming) && (y.transformOrigin = "".concat(this.state.x, " ").concat(this.state.y), y.transform = "scale(".concat(this.state.scale, ")")), import_react.default.createElement(c, _extends({ className: p }, u), import_react.default.createElement(Image$1, _extends({ alt: t2, className: d, tag: i, src: o, onLoad: this.handleImageComplete, onError: this.handleImageComplete }, r2)), import_react.default.createElement(Image$1, { className: h, tag: "div", src: l || o, style: y, isBgImage: true, onFocus: this.handleOnMouseOver, onMouseOver: this.handleOnMouseOver, onBlur: this.handleOnMouseOut, onMouseOut: this.handleOnMouseOut, onMouseMove: this.handleOnMouseMove, onTouchStart: this.handleOnTouchStart, onTouchEnd: this.handleOnTouchEnd, onTouchMove: this.handleOnTouchMove }), this.renderLoading());
...
var _class$9;
var _temp$9;
var Slide = (_temp$9 = _class$9 = function(e2) {
  function t(e3) {
    var i;
  ...
  return _createClass(t, [{ key: "isVisible", value: function() {
    ...
    var e3 = this, t2 = this.props, r2 = t2.ariaLabel, i = (t2.carouselStore, t2.children, t2.className), n = t2.classNameHidden, s2 = t2.classNameVisible, a = (t2.currentSlide, t2.index, t2.innerClassName), o = t2.innerTag, l = t2.naturalSlideHeight, c = t2.naturalSlideWidth, u = (t2.onBlur, t2.onFocus, t2.orientation), p = t2.slideSize, d = t2.style, h = t2.tabIndex, y = t2.tag, S = t2.totalSlides, m = (t2.visibleSlides, t2.isIntrinsicHeight), b = _objectWithoutProperties(t2, _excluded$b), f = {};
    u === "horizontal" ? (f.width = pct(p), f.paddingBottom = pct(100 * l / (c * S))) : (f.width = pct(100), f.paddingBottom = pct(100 * l / c));
    var g = {};
    m && (u === "horizontal" ? f.height = "unset" : f.width = "unset", f.paddingBottom = "unset", g.position = "unset");
    var v = _extends({}, f, d), _ = this.isVisible(), T = cn([s$a.slide, u === "horizontal" && s$a.slideHorizontal, "carousel__slide", this.state.focused && "carousel__slide--focused", _ && s2, _ && "carousel__slide--visible", !_ && n, !_ && "carousel__slide--hidden", i]), k = cn([s$a.slideInner, "carousel__inner-slide", a]), C = this.isVisible() ? 0 : -1, O = typeof h == "number" ? h : C;
    return import_react.default.createElement(y, _extends({ ref: function(t3) {
      e3.tagRef = t3;
    }, tabIndex: O, "aria-selected": this.isVisible(), "aria-label": r2, role: "option", onFocus: this.handleOnFocus, onBlur: this.handleOnBlur, className: T, style: v }, b), import_react.default.createElement(o, { ref: function(t3) {
      e3.innerTagRef = t3;
    }, className: k, style: g }, this.props.children, this.renderFocusRing()));
  } }]), t;
}(import_react.default.PureComponent), _defineProperty(_class$9, "propTypes", { ariaLabel: propTypes.string, carouselStore: propTypes.object, children: CarouselPropTypes.children, className: propTypes.string, classNameHidden: propTypes.string, classNameVisible: propTypes.string, currentSlide: propTypes.number.isRequired, index: propTypes.number.isRequired, innerClassName: propTypes.string, innerTag: propTypes.string, naturalSlideHeight: propTypes.number.isRequired, naturalSlideWidth: propTypes.number.isRequired, onBlur: propTypes.func, onFocus: propTypes.func, orientation: CarouselPropTypes.orientation.isRequired, slideSize: propTypes.number.isRequired, style: propTypes.object, tabIndex: propTypes.number, tag: propTypes.string, totalSlides: propTypes.number.isRequired, visibleSlides: propTypes.number.isRequired, isIntrinsicHeight: propTypes.bool }), _defineProperty(_class$9, "defaultProps", { ariaLabel: "slide", carouselStore: null, children: null, className: null, classNameHidden: null, classNameVisible: null, innerClassName: null, innerTag: "div", onBlur: null, onFocus: null, style: {}, tabIndex: null, tag: "div", isIntrinsicHeight: false }), _temp$9);
...
var GetScrollParent = function() {
  ...
  return _createClass(e2, [{ key: "parents", value: function(e3, t) {
    return e3.parentNode === null ? t : this.parents(e3.parentNode, t.concat([e3]));
...
var _excluded2$2 = ["dragStep", "step", "infinite"];
var _excluded3 = ["className", "onClickCapture", "onMouseDown", "onTouchCancel", "onTouchEnd", "onTouchMove", "onTouchStart", "ref", "style"];
var _class$a;
var _temp$a;
var Slider = (_temp$a = _class$a = function(e2) {
  function t(e3) {
    var i;
    return _classCallCheck(this, t), i = r.call(this, e3), i.getSliderRef = i.getSliderRef.bind(_assertThisInitialized(i)), i.handleDocumentScroll = i.handleDocumentScroll.bind(_assertThisInitialized(i)), i.handleOnClickCapture = i.handleOnClickCapture.bind(_assertThisInitialized(i)), i.handleOnKeyDown = i.handleOnKeyDown.bind(_assertThisInitialized(i)), i.handleOnMouseDown = i.handleOnMouseDown.bind(_assertThisInitialized(i)), i.handleOnMouseMove = i.handleOnMouseMove.bind(_assertThisInitialized(i)), i.handleOnMouseUp = i.handleOnMouseUp.bind(_assertThisInitialized(i)), i.handleOnTouchCancel = i.handleOnTouchCancel.bind(_assertThisInitialized(i)), i.handleOnTouchEnd = i.handleOnTouchEnd.bind(_assertThisInitialized(i)), i.handleOnTouchMove = i.handleOnTouchMove.bind(_assertThisInitialized(i)), i.handleOnTouchStart = i.handleOnTouchStart.bind(_assertThisInitialized(i)), i.playBackward = i.playBackward.bind(_assertThisInitialized(i)), i.playForward = i.playForward.bind(_assertThisInitialized(i)), i.callCallback = i.callCallback.bind(_assertThisInitialized(i)), i.state = { cancelNextClick: false, deltaX: 0, deltaY: 0, isBeingMouseDragged: false, isBeingTouchDragged: false, startX: 0, startY: 0 }, i.interval = null, i.isDocumentScrolling = null, i.moveTimer = null, i.originalOverflow = null, i.scrollParent = null, i.scrollStopTimer = null, i;
  }
  _inherits(t, e2);
  var r = _createSuper(t);
  return _createClass(t, [{ key: "componentDidMount", value: function() {
    this.props.lockOnWindowScroll && window.addEventListener("scroll", this.handleDocumentScroll, false), document.documentElement.addEventListener("mouseleave", this.handleOnMouseUp, false), document.documentElement.addEventListener("mousemove", this.handleOnMouseMove, false), document.documentElement.addEventListener("mouseup", this.handleOnMouseUp, false), this.props.isPlaying && this.play();
  } }, { key: "componentDidUpdate", value: function(e3) {
    !e3.isPlaying && this.props.isPlaying && this.play(), e3.isPlaying && !this.props.isPlaying && this.stop(), !e3.isPageScrollLocked && this.props.isPageScrollLocked && this.lockScroll(), e3.isPageScrollLocked && !this.props.isPageScrollLocked && this.unlockScroll(), e3.privateUnDisableAnimation === false && this.props.privateUnDisableAnimation === true && this.props.carouselStore.setStoreState({ privateUnDisableAnimation: false, disableAnimation: false });
  } }, { key: "componentWillUnmount", value: function() {
    document.documentElement.removeEventListener("mouseleave", this.handleOnMouseUp, false), document.documentElement.removeEventListener("mousemove", this.handleOnMouseMove, false), document.documentElement.removeEventListener("mouseup", this.handleOnMouseUp, false), window.removeEventListener("scroll", this.handleDocumentScroll, false), this.stop(), window.cancelAnimationFrame.call(window, this.moveTimer), window.clearTimeout(this.scrollStopTimer), this.isDocumentScrolling = null, this.moveTimer = null, this.scrollStopTimer = null;
  } }, { key: "getSliderRef", value: function(e3) {
    this.sliderTrayElement = e3;
  } }, { key: "fakeOnDragStart", value: function(e3) {
    var t2 = e3.screenX, r2 = e3.screenY, i = e3.touchDrag, n = i !== void 0 && i, s2 = e3.mouseDrag, a = s2 !== void 0 && s2;
    this.props.carouselStore.setStoreState({ isPlaying: false }), window.cancelAnimationFrame.call(window, this.moveTimer), this.props.orientation === "vertical" && this.props.carouselStore.setStoreState({ isPageScrollLocked: true }), this.setState({ isBeingTouchDragged: n, isBeingMouseDragged: a, startX: t2, startY: r2 });
  } }, { key: "fakeOnDragMove", value: function(e3, t2) {
    var r2 = this;
    this.moveTimer = window.requestAnimationFrame.call(window, function() {
      r2.setState(function(r3) {
        return { deltaX: e3 - r3.startX, deltaY: t2 - r3.startY };
      });
    });
  } }, { key: "fakeOnDragEnd", value: function() {
    window.cancelAnimationFrame.call(window, this.moveTimer), this.computeCurrentSlide(), this.props.orientation === "vertical" && this.props.carouselStore.setStoreState({ isPageScrollLocked: false }), this.setState({ deltaX: 0, deltaY: 0, isBeingTouchDragged: false, isBeingMouseDragged: false }), this.isDocumentScrolling = !this.props.lockOnWindowScroll && null;
  } }, { key: "callCallback", value: function(e3, t2) {
    var r2 = this.props.trayProps;
    r2 && typeof r2[e3] == "function" && (t2.persist(), r2[e3](t2));
    ...
    this.props.orientation === "vertical" && e3.preventDefault();
    ...
    var t2 = e3.keyCode, r2 = this.props, i = r2.carouselStore, n = r2.currentSlide, s2 = r2.disableKeyboard, a = r2.totalSlides, o = r2.visibleSlides, l = {};
    s2 === true || a <= o || (t2 === 37 && (e3.preventDefault(), this.focus(), l.currentSlide = Math.max(0, n - 1), l.isPlaying = false), t2 === 39 && (e3.preventDefault(), this.focus(), l.currentSlide = Math.min(a - o, n + 1), l.isPlaying = false), i.setStoreState(l));
    ...
    this.interval = setInterval(e3 === "forward" ? this.playForward : this.playBackward, this.props.interval);
    ...
    this.props.infinite && (this.props.currentSlide >= i && r2 > 0 && (n = 0), this.props.currentSlide === 0 && r2 < 0 && (n = i)), this.props.carouselStore.setStoreState({ currentSlide: n });
